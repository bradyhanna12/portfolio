...
const experience = [
    {
        id: 1,
        title: "Computer Science Peer Educator | Oregon State University - Corvallis, Oregon",
        time: "November 2025 - Current",
    ...
    {
        id: 2,
        title: "Computer Science Learning Assistant | Oregon State University - Corvallis, Oregon",
        time: "September 2025 - Current",
    ...
    {
        id: 3,
        title: "Data Analyst Intern | Wheelcog Consultants - Remote",
        time: "December 2024 - April 2025",
                ...
                {experience.map((exp, key) => (
                    <div key={key} className="group bg-card rounded-lg overflow-hidden shadow-xs card-hover">
                        ...
                        <div className="p-6">
                            ...
                            <p className="text-muted-foreground text-sm mb-4"> {exp.time} </p>
